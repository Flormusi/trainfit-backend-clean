...
exports.formatPasswordForDisplay = exports.generateSecureTemporaryPassword = exports.validatePassword = exports.generateTemporaryPassword = void 0;
/**
 ...
 */
const generateSecureTemporaryPassword = (count = 5, length = 12) => {
    const passwords = [];
    for (let i = 0; i < count; i++) {
        let password = (0, exports.generateTemporaryPassword)(length);
        // Asegurar que la contraseña generada sea válida
        while (!(0, exports.validatePassword)(password)) {
            password = (0, exports.generateTemporaryPassword)(length);
        }
...
exports.generateSecureTemporaryPassword = generateSecureTemporaryPassword;
/**
 ...
 */
const formatPasswordForDisplay = (password) => {
    return password.match(/.{1,4}/g)?.join('-') || password;
};
exports.formatPasswordForDisplay = formatPasswordForDisplay;
